    ...
    <Container>
      <article style={{ maxWidth: '540px' }} className="pt-12 mx-auto">
        ...
        <p>
          ...
          <b>
            if we sell in Canada, we make a promise and commitment to make
            clothes in Canada
          </b>
          .
        </p>
        ...
        <p>
          ...
          and seismic waste. Currently, in the footwear/clothing industry,
          cheap manufacturing in far-off locations leads to 40%
          overproduction each season. That means nearly half of the clothes
          produced across the world end up in landfills before they are
          ever worn. Countless more are discarded after few wears and
          meaningless lives in the bottom of our closets.
        </p>
        <p>
